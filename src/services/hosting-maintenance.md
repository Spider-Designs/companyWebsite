...
process:
  ...
  steps:
    ...
    - title: 'Migration or Setup'
      body: 'We migrate your existing site or set up a new one on our chosen services'
...
We offer monthly maintenance packages to suit different levels of need:
...
Hosting and maintenance is included in our monthly retainer packages, meaning you can get a new website built and hosted with no upfront cost, paying only a single affordable monthly fee.
